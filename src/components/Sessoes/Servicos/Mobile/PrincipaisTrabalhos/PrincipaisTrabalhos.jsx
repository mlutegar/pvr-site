import {PrincipaisTrabalhosMobileStyle} from "./Style";

const PrincipaisTrabalhosMobile = () => (
    <PrincipaisTrabalhosMobileStyle>
        <div className="container">
            ...
            <div className="conteudo">
                ...
                <div className="parte2">
                    <ul>
                        <li>
                            Atuou como consultor exclusivo do Banco Interamericano de Desenvolvimento – BID, em projeto
                            que
                            constituía a realização de um Market Sounding junto aos principais bancos de atacado e
                            varejo do
...
export default PrincipaisTrabalhosMobile;
